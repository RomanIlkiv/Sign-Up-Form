            ...
            <div class="container-fluid">
				...
				<? if (isset($_SESSION["login"]) && isset($_SESSION["password"])) {?>
					<div class="AcceptBlock col-lg-8 col-md-8 col-sm-8 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2">
						<p>You are already Log In. You can use your profile</p>
						<a href="profile.php">Your profile</a>
					</div>
				<?} else {?>
                    <form action="" method="post" name="registr" class="col-lg-6 col-md-6 col-sm-8 col-xs-10 col-lg-offset-3 col-md-offset-3 col-sm-offset-2 col-xs-offset-1">
                        ...
                        <input type="password" name="password" id="pass" class="my_input" placeholder="Password">
